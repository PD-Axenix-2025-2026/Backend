...
Для нагрузочного тестирования можно отдельно сгенерировать десятки тысяч сегментов маршрутов, не трогая таблицы справочников:
...
- создаёт 30 000 строк в `route_segments`
